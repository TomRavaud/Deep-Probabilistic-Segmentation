...
class RankedLogger(logging.LoggerAdapter):
    ...
    def __init__(
        ...
        Args:
            ...
            rank_zero_only (bool, optional): Whether to force all logs to only occur on
                the rank zero process. Defaults to False.
            extra (Optional[Mapping[str, object]], optional): A dict-like object which
                provides contextual information. See `logging.LoggerAdapter`. Defaults
                to None.
        """
    ...
    def log(self,
        ...
        Args:
            level (int): The level to log at. Look at `logging.__init__.py` for more
                information.
            ...
            kwargs: Any additional keyword args to pass to the underlying logging
                function.

        Raises:
            RuntimeError: If the `rank_zero_only.rank` has not been set before use.
        """
